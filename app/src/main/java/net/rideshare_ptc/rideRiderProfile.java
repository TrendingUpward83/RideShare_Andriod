...
public class rideRiderProfile extends AppCompatActivity {
    User aUser;
    Byte isADriver;
    Ride thisRide;
    String activeRideRider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SDK_INT > 8) {
            ...
            activeRideRider = thisRide.getRiderID();
            if (activeRideRider == null) {
                startActivity(new Intent(rideRiderProfile.this, DriverOnlySplash.class).putExtra("Success Ride Posted", "No rider accepted this requested ride yet."));
            } else {
                try {

                    aUser = getRideUserDetails(activeRideRider);
        ...
        btnReturnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(rideRiderProfile.this, MainMenu.class));
            }
        });
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(rideRiderProfile.this, MainActivity.class));
            }
        });
    }
    public User getRideUserDetails(String driverID) throws IOException {
        ...
        try {
            ...
            startActivity(new Intent(rideRiderProfile.this, DriverOnlySplash.class).putExtra("Success Ride Posted", "Connection Error: \n ERROR \n"+"URL"+ urld.toString()+"\n"+e));
        }
        con.disconnect();
        return retUser;
    }
